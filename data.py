...
class CourierLoginData:
    # Неверные данные для тестирования негативных сценариев
...
class OrdersParamsData:
    ...
    # Существующий id курьера в системе, станция метро "Бульвар Рокоссовского"(1)
